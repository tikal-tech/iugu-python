...
def check_tests_environment():
    ...
    try:
        ...
        raise errors.IuguConfigTestsErrors(
            "Only for tests is required an environment "
...
class TestMerchant(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = merchant.IuguMerchant(account_id=ACCOUNT_ID, api_mode_test=True)

    def tearDown(self):
        pass

    def test_create_payment_token_is_test(self):
        response = self.client.create_payment_token(
            "4111111111111111", "JA", "Silva", "12", "2010", "123"
        )
    ...
    def test_create_charge_credit_card(self):
        ...
        token = self.client.create_payment_token(
            "4111111111111111", "JA", "Silva", "12", "2010", "123"
        )
...
class TestCustomer(unittest.TestCase):
    ...
    def test_create_customer_basic_info(self):
        consumer = customers.IuguCustomer(
            api_mode_test=True, email=self.random_user_email
        )
        c = consumer.create()
        c.remove()
    ...
    def test_create_customer_extra_attrs(self):
        ...
        c = consumer.create(
            name="Mario Lago", notes="It's the man", custom_variables={"local": "cup"}
        )
        c.remove()
    ...
    def test_customer_delete_by_id(self):
        ...
        self.assertRaises(errors.IuguGeneralException, consumer.get, consumer_new.id)
...
class TestCustomerLists(unittest.TestCase):
    def setUp(self):
        ...
        self.c = customers.IuguCustomer(
            api_mode_test=True, email=self.random_user_email
        )

        # creating customers for tests with lists
        p1, p2, p3 = "Andrea", "Bruna", "Carol"
        self.one = self.c.create(
            name=p1, notes="It's the man", custom_variables={"local": "cup"}
        )

        # I'm not happy with it (sleep), but was need. This certainly occurs because
        # time data is not a timestamp.
        sleep(1)
        self.two = self.c.create(
            name=p2, notes="It's the man", custom_variables={"local": "cup"}
        )
        sleep(1)
        self.three = self.c.create(
            name=p3, notes="It's the man", custom_variables={"local": "cup"}
        )
        sleep(1)
    ...
    def test_getitems_sort(self):
        ...
        if len(customers_list) < 4:
            ...
            raise TypeError(
                "API Database is not empty. This test isn't useful. "
...
class TestCustomerPayments(unittest.TestCase):
    def setUp(self):
        ...
        self.instance_payment = self.customer.payment.create(
    ...
    def test_create_payment_method_new_user_by_create(self):
        ...
        of IuguCustomer
        """
        instance_payment = self.customer.payment.create(
            description="New payment method",
            number="4111111111111111",
            verification_value=123,
            first_name="Joao",
    ...
    def test_create_payment_method_existent_user_by_get(self):
        ...
        instance_payment = existent_customer.payment.create(
            description="New payment method",
            number="4111111111111111",
            verification_value=123,
            first_name="Joao",
    ...
    def test_create_payment_method_existent_user_by_getitems(self):
        ...
        instance_payment = c_0.payment.create(
            description="New payment method",
            number="4111111111111111",
            verification_value=123,
            first_name="Joao",
    ...
    def test_create_payment_method_non_existent_user_by_instance(self):
        ...
        self.assertRaises(
            errors.IuguPaymentMethodException,
            create,
            description="New payment method",
            number="4111111111111111",
            verification_value=123,
    ...
    def test_set_payment_by_payment_id_customer_id(self):
        ...
        id = self.instance_payment.id
        # two args passed
        payment = self.client.payment.set(
            id, "New Card Name", customer_id=self.customer.id
        )
        self.assertTrue(isinstance(payment, customers.IuguPaymentMethod))
    ...
    def test_set_payment_remove(self):
        ...
        self.assertRaises(
            errors.IuguGeneralException, payment_test, instance_payment.id
        )
    ...
    def test_set_payment_remove_by_attrs(self):
        ...
        instance_payment.remove()
        self.assertRaises(
            errors.IuguGeneralException, instance_payment.get, instance_payment.id
        )

    def test_getitems_payments(self):
        payment_one = self.customer.payment.create(
            description="New payment One",
            number="4111111111111111",
            verification_value=123,
            first_name="World",
            last_name="Cup",
        ...
        payment_two = self.customer.payment.create(
            description="New payment Two",
            number="4111111111111111",
            verification_value=123,
            first_name="Is a ",
            last_name="Problem",
        ...
        payment_three = self.customer.payment.create(
            description="New payment Three",
            number="4111111111111111",
            verification_value=123,
            first_name="To Brazil",
            last_name="Worry",
            month=12,
            year=2015,
        )
        ...
        self.assertTrue(isinstance(list_of_payments[0], customers.IuguPaymentMethod))
...
class TestInvoice(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.item = item
        self.invoice_obj = invoices.IuguInvoice(
            email=self.customer_email, item=item, due_date=self.TODAY
        )
    ...
    def test_invoice_raise_required_due_date(self):
        i = invoices.IuguInvoice()
        self.assertRaises(
            errors.IuguInvoiceException, i.create, email="h@gmail.com", items=self.item
        )
    ...
    def test_invoice_create_all_fields_as_draft(self):
        response = self.invoice_obj.create(
            draft=True,
            return_url="http://hipy.co/success",
    ...
    def test_invoice_create_with_custom_variables_in_create(self):
        invoice = self.invoice_obj.create(
            draft=True, custom_variables={"city": "Brasilia"}
        )
    ...
    def test_invoice_create_with_custom_variables_in_set(self):
        invoice = self.invoice_obj.set(
            invoice_id=self.invoice.id, custom_variables={"city": "Brasilia"}
        )
        self.assertEqual(invoice.custom_variables[0]["name"], "city")
        self.assertEqual(invoice.custom_variables[0]["value"], "Brasilia")
    ...
    def test_invoice_edit_return_url_with_set(self):
        ...
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(invoice_id=id, return_url=return_url)
    ...
    def test_invoice_edit_expired_url_with_set(self):
        ...
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(invoice_id=id, expired_url=expired_url)
    ...
    def test_invoice_edit_notification_url_with_set(self):
        ...
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(
            invoice_id=id, notification_url=notification_url
        )
    ...
    def test_invoice_edit_tax_cents_with_set(self):
        tax_cents = 200
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(invoice_id=id, tax_cents=tax_cents)
    ...
    def test_invoice_edit_discount_cents_with_set(self):
        ...
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(
            invoice_id=id, discount_cents=discount_cents
        )
    ...
    def test_invoice_edit_customer_id_with_set(self):
        customer_id = self.consumer.id
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(invoice_id=id, customer_id=customer_id)
    ...
    def test_invoice_edit_ignore_due_email_with_set(self):
        ...
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(
            invoice_id=id, ignore_due_email=ignore_due_email
        )
    ...
    def test_invoice_edit_due_date_with_set(self):
        ...
        id = self.invoice.id
        invoice_edited = self.invoice_obj.set(invoice_id=id, due_date=due_date)
    ...
    def test_invoice_edit_items_with_set(self):
        ...
        self.assertEqual(
            invoice_edited.items[0].description, "Prod Fixed Text and Value"
        )
...
class TestPlans(unittest.TestCase):
    ...
    def test_plan_remove(self):
        ...
        new_plan.remove()
        self.assertRaises(errors.IuguGeneralException, plans.IuguPlan.get, removed_id)
    ...
    def test_plan_edit_changes_currency_by_set(self):
        ...
        new_currency = "US"
        self.assertRaises(
            errors.IuguPlansException, self.plan.set, plan_id, currency=new_currency
        )
    ...
    def test_plan_edit_changes_features_name_by_set(self):
        ...
        self.assertEqual(plan_changed.features[0].name, plan_returned.features[0].name)
    ...
    def test_plan_edit_changes_features_identifier_by_set(self):
        ...
        self.assertEqual(
            plan_changed.features[0].identifier, plan_returned.features[0].identifier
        )
        plan_returned.remove()
    ...
    def test_plan_edit_changes_features_value_by_set(self):
        ...
        self.assertEqual(
            plan_changed.features[0].value, plan_returned.features[0].value
        )
        plan_returned.remove()
    ...
    def test_plan_edit_changes_identifier_by_save(self):
        seed = randint(1, 999)
        self.plan.identifier = "New_identifier_%s_%s" % (self.identifier, seed)
        response = self.plan.save()
...
class TestSubscriptions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plan_new = plans.IuguPlan().create(
            name=plan_name,
        ...
        self.plan_two = plans.IuguPlan().create(
            name="Plan Two",
        ...
        self.subscription = subs_obj.create(
            customer_id=self.customer.id, plan_identifier=self.plan_two.identifier
        )
    ...
    def test_subscription_set_with_custom_variables(self):
        p_obj = subscriptions.IuguSubscription()
        subscription_new = p_obj.set(
            sid=self.subscription.id, custom_variables={"city": "Recife"}
        )
        self.assertEqual(subscription_new.custom_variables[0]["name"], "city")
        self.assertEqual(subscription_new.custom_variables[0]["value"], "Recife")
        # self.clean_invoices(subscription_new.recent_invoices)
    ...
    def test_subscription_create_only_on_charge_success_with_payment(self):
        ...
        customer = customers.IuguCustomer().create(
            name="Pay now", email="pay_now@local.com"
        )
        pay = customer.payment.create(
        ...
        p_obj = subscriptions.IuguSubscription()
        new_subscription = p_obj.create(
            customer.id, self.plan_new.identifier, only_on_charge_success=True
        )
    ...
    def test_subscription_remove(self):
        ...
        subscription_new.remove()
        self.assertRaises(
            errors.IuguGeneralException, subscriptions.IuguSubscription.get, sid
        )
    ...
    def test_subscription_getitem_customer_id(self):
        ...
        sub_2 = client_subscriptions.create(self.customer.id, self.plan_new.identifier)
        sleep(3)
        subscriptions_list = subscriptions.IuguSubscription.getitems(
    ...
    def test_subscription_set_plan(self):
        ...
        plan_newest = plans.IuguPlan().create(
            "Plan Name: Newest", plan_identifier, 1, "months", "BRL", 5000
        )
        # editing...
        subscription = subscriptions.IuguSubscription().set(
            sid, plan_identifier=plan_newest.identifier
        )
    ...
    def test_subscription_set_customer_id(self):
        ...
        customer = customers.IuguCustomer().create(
            name="Cortella", email="mcortella@usp.br"
        )
        subscription = subscriptions.IuguSubscription().set(
            self.subscription.id, customer_id=customer.id
        )
    ...
    def test_subscription_set_expires_at(self):
        ...
        subscription = subscriptions.IuguSubscription().set(
            self.subscription.id, expires_at="12/12/2014"
        )
    ...
    def test_subscription_set_suspended(self):
        ...
        subscription = subscriptions.IuguSubscription().set(
            self.subscription.id, suspended=True
        )
    ...
    def test_subscription_set_skip_charge(self):
        ...
        subscription = subscriptions.IuguSubscription().set(
            self.subscription.id, skip_charge=True
        )
        self.assertEqual(subscription.suspended, True)
    ...
    def test_subscription_set_subitems(self):
        ...
        subscription = subscriptions.IuguSubscription().set(
            self.subscription.id, subitems=[subitem,]
        )
        self.assertEqual(subscription.subitems[0].description, subitem.description)
    ...
    def test_subscription_set_subitems_description(self):
        ...
        subscription = subscriptions.IuguSubscription().set(
            self.subscription.id, subitems=[item_with_id,]
        )
        self.assertEqual(subscription.subitems[0].description, item_with_id.description)
    ...
    def test_subscription_set_subitems_price_cents(self):
        ...
        self.assertEqual(subscription.subitems[0].price_cents, item_with_id.price_cents)
    ...
    def test_subscription_set_subitems_quantity(self):
        ...
        self.assertEqual(subscription.subitems[0].quantity, item_with_id.quantity)
    ...
    def test_subscription_set_subitems_recurrent(self):
        ...
        self.assertEqual(subscription.subitems[0].recurrent, item_with_id.recurrent)
    ...
    def test_subscription_create_credit_based_with_custom_variables(self):
        ...
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id,
            credits_cycle=2,
            price_cents=10,
            custom_variables={"city": "Recife"},
    ...
    def test_subscription_set_credit_based_with_custom_variables(self):
        # Test if price_cents changed
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id, credits_cycle=2, price_cents=10
        )
        subscription = subscriptions.SubscriptionCreditsBased().set(
            subscription.id, custom_variables={"city": "Madrid"}
        )
        self.assertEqual(subscription.custom_variables[0]["name"], "city")
    ...
    def test_subscription_create_credit_based_price_cents(self):
        # Test if price_cents changed
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id, credits_cycle=2, price_cents=2000
        )
    ...
    def test_subscription_create_credit_based_credits_min(self):
        # Test if price_cents changed
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id, credits_cycle=2, price_cents=2000, credits_min=4000
        )
    ...
    def test_subscription_set_credit_based_price_cents(self):
        # Test if price_cents changed
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id, credits_cycle=2, price_cents=1200
        )

        subscription = subscriptions.SubscriptionCreditsBased().set(
            subscription.id, price_cents=3249
        )
    ...
    def test_subscription_set_credits_cycle(self):
        ...
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id, credits_cycle=2, price_cents=1300
        )

        subscription = subscriptions.SubscriptionCreditsBased().set(
            subscription.id, credits_cycle=10
        )
    ...
    def test_subscription_set_credits_min(self):
        ...
        subscription = subscriptions.SubscriptionCreditsBased().create(
            self.customer.id, credits_cycle=2, price_cents=1400
        )

        subscription = subscriptions.SubscriptionCreditsBased().set(
            subscription.id, credits_min=2000
        )
    ...
    def test_subscription_credit_based_get(self):
        ...
        subscription = subscriptions.SubscriptionCreditsBased().get(subscription.id)
    ...
    def test_subscription_credit_based_getitems(self):
        ...
        sleep(2)
        subscription_list = subscriptions.SubscriptionCreditsBased().getitems()

        self.assertIsInstance(
            subscription_list[0], subscriptions.SubscriptionCreditsBased
        )
        self.clean_invoices(subscription.recent_invoices)
        subscription.remove()
    ...
    def test_subscription_save_customer_id(self):
        ...
        customer = customers.IuguCustomer().create(
            name="Subs save", email="subs_save@local.com"
        )
    ...
    def test_subscription_save_subitems(self):
        ...
        subitem = merchant.Item("Subitems", 1, 2345)
        self.subscription.subitems = [
            subitem,
        ]
        obj = self.subscription.save()
        self.assertEqual(obj.subitems[0].description, subitem.description)
    ...
    def test_subscription_save_subitems_description(self):
        ...
        obj = self.subscription.save()
        self.assertEqual(obj.subitems[0].description, item_with_id.description)
    ...
    def test_subscription_save_subitems_price_cents(self):
        ...
        obj = self.subscription.save()
        self.assertEqual(obj.subitems[0].price_cents, item_with_id.price_cents)
    ...
    def test_subscription_save_subitems_quantity(self):
        ...
        obj = self.subscription.save()
        self.assertEqual(obj.subitems[0].quantity, item_with_id.quantity)
    ...
    def test_subscription_save_subitems_recurrent(self):
        ...
        obj = self.subscription.save()
        self.assertEqual(obj.subitems[0].recurrent, item_with_id.recurrent)
    ...
    def test_subscription_save_price_cents(self):
        ...
        subscription = subscription.create(
            customer_id=self.customer.id, credits_cycle=2, price_cents=1000
        )
    ...
    def test_subscription_save_credits_min(self):
        subscription = subscriptions.SubscriptionCreditsBased()
        subscription = subscription.create(
            customer_id=self.customer.id, credits_cycle=2, price_cents=1100
        )
    ...
    def test_subscription_change_plan(self):
        ...
        plan_again_change = plans.IuguPlan().create(
            name="Change Test",
            identifier=identifier,
            interval=1,
            interval_type="months",
        ...
        obj = subscriptions.IuguSubscription().change_plan(
            plan_again_change.identifier, sid=self.subscription.id
        )
    ...
    def test_subscription_add_credits(self):
        ...
        obj = subscriptions.SubscriptionCreditsBased().add_credits(
            sid=subscription.id, quantity=20
        )
    ...
    def test_subscription_add_credits_by_instance(self):
        ...
        obj = subscription.add_credits(sid=subscription.id, quantity=20)
        self.assertEqual(obj.credits, 20)
        self.clean_invoices(subscription.recent_invoices)
        subscription.remove()
    ...
    def test_subscription_remove_credits(self):
        ...
        obj = subscriptions.SubscriptionCreditsBased().remove_credits(
            sid=subscription.id, quantity=5
        )
